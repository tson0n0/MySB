...
('ZIP', '<InstallDir>/web/apps/ru', 'ruTorrent', '3.8_dd7ed86', 0, 'ruTorrent_v3.8_dd7ed86.zip', 'https://github.com/toulousain79/MySB_files/raw/v99.99/ruTorrent_v3.8_dd7ed86.zip', 1, 0, ''),
